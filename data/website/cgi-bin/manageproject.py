...
if uid=='':
	...
	if year=='' or project=='':
		...
		projectmenu()
		br()
		helpbutton('How to manage your project', 'Please click on your project name then select '+strong('Add File')+' to add a zip file containing your project\'s website.<br>Afterwards you will be able to view your uploaded files\' structure and the current view of the website.<br>Once your project has been uploaded, you will need to fill in your project\'s details in the metadata tab.<br><br>When you are satisfied with your project upload you will be able to submit it for moderation.')
		br()
